...
The logic in this module is inspired by [`@nuxtjs/device`](https://github.com/nuxt-modules/device),
but our implementation takes a different approach:

- we do not install a global plugin, making the core bundle smaller
- device flags are reactive and recalculated client side, making the module usable in prerendered
  routes
